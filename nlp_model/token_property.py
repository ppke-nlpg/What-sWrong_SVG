...
class TokenProperty:
    ...
    property values, such as "house" or "NN". Each TokenProperty has a name
    (say 'Word') and an integer 'level' that can be used to define an order on
    ...
    def __init__(self, name: str=None, level: int=0):
        ...
        Args:
            name (str, optional): The name of the property. If not given then
                it is set to 'Property <level>' where <level> is the level of
    ...
    def __lt__(self, other):
        ...
        Returns:
            bool: True iff the tokens level is less than the other token's
            level, or the levels are identical but the token's name is
            lexicographically smaller than the other.
        """
