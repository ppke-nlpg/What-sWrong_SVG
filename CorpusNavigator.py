...
class CorpusNavigator:
    ...
    def updateCanvas(self):  # XXX MISSING STUFF HERE!
        ...
        if self._gold is not None:
            ...
            self._edgeTypeFilter.add_allowed_prefix_type("dep")
            self._edgeTypeFilter.add_allowed_prefix_type("role")
            self._edgeTypeFilter.add_allowed_prefix_type("sense")
            self._edgeTypeFilter.add_allowed_prefix_type("ner")
            self._edgeTypeFilter.add_allowed_prefix_type("chunk")
            self._edgeTypeFilter.add_allowed_prefix_type("pos")
            self._edgeTypeFilter.add_allowed_prefix_type("align")
